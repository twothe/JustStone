 ...
 * @author Two
 */
public class JustStoneChunk extends Chunk {

  public JustStoneChunk(final World world, final Block[] chunkData, final int chunkX, final int chunkZ) {
    super(world, chunkX, chunkZ);
    final int worldHeight = world.provider.getHeight();
